...
mock.onGet('/blogRd/list/data').reply(() => [200, data.blogList])
mock.onGet('/blogRd/list/data/sidebar').reply(() => [200, data.blogSidebar])
mock.onGet('/blogRd/list/data/detail').reply(() => [200, data.blogDetail])
mock.onGet('/blogRd/list/data/edit').reply(() => [200, data.blogEdit])

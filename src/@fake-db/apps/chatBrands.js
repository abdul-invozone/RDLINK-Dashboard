...
// ------------------------------------------------
mock.onGet('/apps/chatBrands/chats-and-contacts').reply(() => {
...
// ------------------------------------------------
mock.onGet('/apps/chatBrands/users/profile-user').reply(() => [200, data.profileUser])

// ------------------------------------------------
// GET: Return Single Chat
// ------------------------------------------------
mock.onGet('/apps/chatBrands/get-chat').reply(config => {
...
// ------------------------------------------------
mock.onPost('/apps/chatBrands/send-msg').reply(config => {

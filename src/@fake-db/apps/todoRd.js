...
// GET: Return Tasks
// ------------------------------------------------
mock.onGet('/apps/todoRd/tasks').reply(config => {
...
// POST: Add new task
// ------------------------------------------------
mock.onPost('/apps/todoRd/add-tasks').reply(config => {
...
// POST: Update Task
// ------------------------------------------------
mock.onPost('/apps/todoRd/update-task').reply(config => {
...
// DELETE: Remove Task
// ------------------------------------------------
mock.onDelete('/apps/todoRd/delete-task').reply(config => {

...
// GET: Return Tasks
// ------------------------------------------------
mock.onGet('/apps/todoBrands/tasks').reply(config => {
...
// POST: Add new task
// ------------------------------------------------
mock.onPost('/apps/todoBrands/add-tasks').reply(config => {
...
// POST: Update Task
// ------------------------------------------------
mock.onPost('/apps/todoBrands/update-task').reply(config => {
...
// DELETE: Remove Task
// ------------------------------------------------
mock.onDelete('/apps/todoBrands/delete-task').reply(config => {

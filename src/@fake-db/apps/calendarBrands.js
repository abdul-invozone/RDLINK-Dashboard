...
// ------------------------------------------------
mock.onGet('/apps/calendarBrands/events').reply(config => {
...
// POST: Add new event
// ------------------------------------------------
mock.onPost('/apps/calendarBrands/add-event').reply(config => {
...
// POST: Update Event
// ------------------------------------------------
mock.onPost('/apps/calendarBrands/update-event').reply(config => {
...
// DELETE: Remove Event
// ------------------------------------------------
mock.onDelete('/apps/calendarBrands/remove-event').reply(config => {

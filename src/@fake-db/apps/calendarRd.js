...
// ------------------------------------------------
mock.onGet('/apps/calendarRd/events').reply(config => {
...
// POST: Add new event
// ------------------------------------------------
mock.onPost('/apps/calendarRd/add-event').reply(config => {
...
// POST: Update Event
// ------------------------------------------------
mock.onPost('/apps/calendarRd/update-event').reply(config => {
...
// DELETE: Remove Event
// ------------------------------------------------
mock.onDelete('/apps/calendarRd/remove-event').reply(config => {

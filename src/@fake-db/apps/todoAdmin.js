...
// GET: Return Tasks
// ------------------------------------------------
mock.onGet('/apps/todoAdmin/tasks').reply(config => {
...
// POST: Add new task
// ------------------------------------------------
mock.onPost('/apps/todoAdmin/add-tasks').reply(config => {
...
// POST: Update Task
// ------------------------------------------------
mock.onPost('/apps/todoAdmin/update-task').reply(config => {
...
// DELETE: Remove Task
// ------------------------------------------------
mock.onDelete('/apps/todoAdmin/delete-task').reply(config => {

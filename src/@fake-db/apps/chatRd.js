...
// ------------------------------------------------
mock.onGet('/apps/chatRd/chats-and-contacts').reply(() => {
...
// ------------------------------------------------
mock.onGet('/apps/chatRd/users/profile-user').reply(() => [200, data.profileUser])

// ------------------------------------------------
// GET: Return Single Chat
// ------------------------------------------------
mock.onGet('/apps/chatRd/get-chat').reply(config => {
...
// ------------------------------------------------
mock.onPost('/apps/chatRd/send-msg').reply(config => {

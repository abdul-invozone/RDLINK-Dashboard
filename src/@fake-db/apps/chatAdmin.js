...
// ------------------------------------------------
mock.onGet('/apps/chatAdmin/chats-and-contacts').reply(() => {
...
// ------------------------------------------------
mock.onGet('/apps/chatAdmin/users/profile-user').reply(() => [200, data.profileUser])

// ------------------------------------------------
// GET: Return Single Chat
// ------------------------------------------------
mock.onGet('/apps/chatAdmin/get-chat').reply(config => {
...
// ------------------------------------------------
mock.onPost('/apps/chatAdmin/send-msg').reply(config => {

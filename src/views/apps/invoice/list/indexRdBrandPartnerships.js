...
// ** Table Columns
import { columnsRdBrandPartnerships } from './columnsRdBrandPartnerships'
...
const InvoiceListRdBrandPartnerships = () => {
  const dummyData = {
    invoices: [
      {
        id: 7049,
  ...
  return (
    <div className='invoice-list-wrapper'>
      <Card>
      <h2 className="main-heading text-center-sm">My Partnerships</h2>
        <div className='invoice-list-dataTable'>
          <DataTable
            ...
            paginationServer
            subHeader={true}
            columns={columnsRdBrandPartnerships}
            responsive={true}
...
export default InvoiceListRdBrandPartnerships

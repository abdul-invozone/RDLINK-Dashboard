...
// ** Table Columns
import { columnsRecommendedRdOppo } from './columnsRecommendedRdOppo'
...
const InvoiceListRecommendedRdOppo = () => {
  const dummyData = {
    invoices: [
      {
        id: 7062,
  ...
  return (
    <div className='invoice-list-wrapper recommended-rd'>
      <Card>
      <h3 className="recommended-opportunities justify-content-sm-center">Recommended Opportunities</h3>
        <div className='invoice-list-dataTable invoice-list-dataTable-brands-dashboard'>
          <DataTable
            ...
            paginationServer
            subHeader={true}
            columns={columnsRecommendedRdOppo}
            responsive={true}
...
export default InvoiceListRecommendedRdOppo

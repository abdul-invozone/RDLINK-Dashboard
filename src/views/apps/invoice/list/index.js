  ...
  return (
    <div className='invoice-list-table-header w-100 py-2'>
      <Row className="invoice-list-row">
        <Col lg='6' className='d-flex align-items-center px-0 px-lg-1 invoice-list-column'>
    ...
    <div className='invoice-list-wrapper manage-rds'>
      ...
      <h2 className="main-heading">Manage RD's</h2>
        <div className='invoice-list-dataTable'>
          ...
          />
        <h6 className="showEntries">Showing 1 to {rowsPerPage} of {store.total} entries</h6>
        </div>
      </Card>
    </div>
  )

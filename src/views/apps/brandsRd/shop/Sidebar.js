...
import { Card, CardBody, Row, Col, CustomInput, Button, CardHeader, CardTitle } from 'reactstrap'
...
const Sidebar = props => {
  ...
  const brands = [
    ...
    {
      title: 'Sustainably Sourced or Produced'
    },
    {
      title: 'Social Mission Driven'
    },
    {
      title: 'Certified BCorp'
    },
    {
      title: 'Women Owned/Female Founded'
    },
    {
      title: 'BIPOC Owned'
    },
    ...
    <div className='sidebar-detached sidebar-left'>
      <div className='sidebar'>
        ...
        >
          <Row>
            <Col sm='12'>
              <h4 className='filter-heading d-none d-lg-block'>All Brands</h4>
            </Col>
          </Row>
          <Card>
            <CardHeader>

...
import NavbarComponentRd from './components/navbarRd'
import SidebarComponentRd from './components/menu/vertical-menu-rd'
...
const VerticalLayoutRd = props => {
  ...
  return (
    ...
    >
      ...
      >
        <div className='navbar-container d-flex content navbarContainerRd'>
          {navbar ? navbar : <NavbarComponentRd setMenuVisibility={setMenuVisibility} skin={skin} setSkin={setSkin} />}
        </div>
      </Navbar>
      {children}

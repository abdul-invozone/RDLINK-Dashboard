...
import NavbarComponentBrands from './components/navbarBrands'
import SidebarComponentBrands from './components/menu/vertical-menu-brands'
...
const VerticalLayoutBrands = props => {
  // ** Props
  ...
  return (
    ...
    >
      ...
      >
        <div className='navbar-container d-flex content navbarContainerBrands'>
          {navbar ? navbar : <NavbarComponentBrands setMenuVisibility={setMenuVisibility} skin={skin} setSkin={setSkin} />}
        </div>
      </Navbar>
      {children}

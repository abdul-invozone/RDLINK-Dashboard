...
const VerticalMenuHeader = props => {
  ...
  return (
    ...
    <Avatar img={defaultAvatar} imgHeight='91' imgWidth='91' />
      </div>
      <div className="col">
      <Link to="/loginrd" className='user-name font-weight-medium text-white'>Manitoba Milling Co.</Link>
      <ul>
        <li className="d-inline-block mr-1" style={{marginTop: '3px'}}>
          ...
          <NavLink to="/brands/apps/chat/chatBrands" className="text-white"><Mail size={18} /></NavLink>
          </li>
          {/* <li className="d-inline-block">
          <NavLink to="/apps/todoBrands" className="text-white"><CheckSquare size={18} /></NavLink>
          </li> */}
      </ul>
      </div>
    </div>

    ...
    <Avatar img={userAvatar} imgHeight='91' imgWidth='91' status='online' />
      ...
      <ul>
        <li className="d-inline-block mr-1" style={{marginTop: '3px'}}>
          ...
          <NavLink to="/brands/apps/chat/chatAdmin" className="text-white"><Mail size={18} /></NavLink>
          </li>
          {/* <li className="d-inline-block">
          <NavLink to="/apps/todoAdmin" className="text-white"><CheckSquare size={18} /></NavLink>
          </li> */}
      </ul>
      </div>
    </div>
